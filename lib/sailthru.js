...
(function() {
  var LOGGING, SailthruClient, SailthruRequest, SailthruUtil, USER_AGENT, fs, http, https, log, log2, querystring, rest, url, _ref,
    __slice = [].slice;
  ...
  SailthruClient = (function() {
    ...
    */
    ...
    SailthruClient.prototype.apiPostMultiPart = function(action, data, callback, binary_data_params) {
      var binary_data, json_payload, param, stats, value, _i, _len, _url;
      if (binary_data_params == null) {
        binary_data_params = [];
      }
      binary_data = {};
